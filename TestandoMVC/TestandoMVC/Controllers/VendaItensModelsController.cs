...
{
    public class VendaItensModelsController : Controller
    {
        private readonly MVCVendasAppContext _context;

        public VendaItensModelsController(MVCVendasAppContext context)
        {
            _context = context;
        }

        // GET: VendaItensModels
        ...
        // GET: VendaItensModels/Details/5
        ...
        // POST: VendaItensModels/Delete/5
